...
public class AnswerActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int attempts = launchingIntent.getIntExtra("attempts", 0);
        int count = launchingIntent.getIntExtra("count", 0);
        final String questions = launchingIntent.getStringExtra("questions");
        ...
        returnButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(questions.length() == 0) {
                    ...
                    next = new Intent (AnswerActivity.this, QuestionActivity.class);
                    next.putExtra("questions", questions);
                    next.putExtra("attempts", attempts);
                    next.putExtra("total", realCount);
                }
                startActivity(next);
